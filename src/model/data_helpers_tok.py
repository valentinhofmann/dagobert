        ...
        with open(filename, 'r') as f:
            ...
            for l in f:
                ...
                if self.mode == 'pfx' and len(d[0]) == 1 and len(d[2]) == 0:
                    ...
                    s = ['[CLS]'] + self.tok.tokenize(s_1) + ['[MASK]'] + self.tokenize(b) + self.tok.tokenize(s_2) + ['[SEP]']
                ...
                # Suffix
                    ...
                    # Tokenize sentence and add mask token
                    s = ['[CLS]'] + self.tok.tokenize(s_1) + self.tokenize(b) + ['[MASK]'] + self.tok.tokenize(s_2) + ['[SEP]']
                ...
                # Both
                    ...
                    s = ['[CLS]'] + self.tok.tokenize(s_1) + ['[MASK]'] + self.tokenize(b) + ['[MASK]'] + self.tok.tokenize(s_2) + ['[SEP]']
