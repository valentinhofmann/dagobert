...
prefix_list = []
with open(str(Path(__file__).parent.parent.parent / 'data/external/bert_prefixes.txt'), 'r', encoding='utf8') as file:
    for line in file:
        if line.strip() == '':
            continue
...
suffix_list = []
with open(str(Path(__file__).parent.parent.parent / 'data/external/bert_suffixes.txt'), 'r', encoding='utf8') as file:
    for line in file:
        if line.strip() == '':
            continue
...
core = set()
with open(str(Path(__file__).parent.parent.parent / 'data/external/bert_core.txt'), 'r', encoding='utf8') as file:
    for line in file:
        if line.strip() == '':
            continue
